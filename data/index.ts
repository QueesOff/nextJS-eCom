...
export const products = [
  ...
  },
  {
    ...
    price: 1750,
    description:
      'As the gold standard for headphones, the classic XX99 Mark I offers detailed and accurate audio reproduction for AudioStores, mixing engineers, and music aficionados alike in studios and on the go.',
    features:
  ...
  },
  {
    ...
    price: 3500,
    description:
      'Stream high quality sound wirelessly with minimal to no loss. The ZX7 speaker uses high-end AudioStore components that represents the top of the line powered speakers for home or studio use.',
    features:
